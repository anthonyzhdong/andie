...
public class Andie {
    ...
    //Launches GUI frame for application (outside so accessable fro other classes)
    ...
    //Split menu bar out for language change purposes without losing functionality of menubar
