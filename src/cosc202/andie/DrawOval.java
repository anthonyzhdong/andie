 ...
 * 
 * <p>
 * This class uses an Ellipse2D object to specify the dimensions of the oval to
 * be drawn.
 * It also allows customization of the oval's outline color, fill color, line
 * size, and fill/outline options.
 * </p>
 * 
 * <p>
...
public class DrawOval implements ImageOperation, java.io.Serializable {
    ...
    /**
     * Construct a DrawOval object with the given ellipse, outline color, fill
     * color, line size, fill option, and outline option.
     * 
     ...
     */
    public DrawOval(Ellipse2D ellipse2d, Color shapeOC, Color shapeFC, float ls, boolean sf, boolean so, boolean oed,
            boolean fed) {
    ...
    public BufferedImage apply(BufferedImage input) {
        ...
        if (shapeFill) {
            ...
            g.fillOval((int) ellipse2d.getX(), (int) ellipse2d.getY(), (int) ellipse2d.getWidth(),
                    (int) ellipse2d.getHeight());
        }
        if (shapeOutline) {
            ...
            g.drawOval((int) ellipse2d.getX(), (int) ellipse2d.getY(), (int) ellipse2d.getWidth(),
                    (int) ellipse2d.getHeight());
        }
