...
public class EditActions {
    ...
    public EditActions() {
        ...
        actions.add(new UndoAction(SettingsActions.bundle.getString("Undo"), null, SettingsActions.bundle.getString("Undo"), Integer.valueOf(KeyEvent.VK_Z)));
        actions.add(new RedoAction(SettingsActions.bundle.getString("Redo"), null, SettingsActions.bundle.getString("Redo"), Integer.valueOf(KeyEvent.VK_Y)));
    }
    ...
    public JMenu createMenu() {
        JMenu editMenu = new JMenu(SettingsActions.bundle.getString("Redo"));
