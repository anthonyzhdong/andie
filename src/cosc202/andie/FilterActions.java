...
public class FilterActions {
    ...
    public FilterActions() {
        ...
        actions.add(new BrightnessAction(SettingsActions.bundle.getString("Brighten"), null, SettingsActions.bundle.getString("BrightenDesc"), Integer.valueOf(KeyEvent.VK_M)));
    }
