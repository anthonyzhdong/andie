...
public class ViewActions {
    ...
    public ViewActions() {
        ...
        actions.add(new ZoomInAction(SettingsActions.bundle.getString("ZoomIn"), null, SettingsActions.bundle.getString("ZoomIn"), Integer.valueOf(KeyEvent.VK_PLUS)));
        actions.add(new ZoomOutAction(SettingsActions.bundle.getString("ZoomOut"), null, SettingsActions.bundle.getString("ZoomOut"), Integer.valueOf(KeyEvent.VK_MINUS)));
        actions.add(new ZoomFullAction(SettingsActions.bundle.getString("ZoomFull"), null, SettingsActions.bundle.getString("ZoomFull"), Integer.valueOf(KeyEvent.VK_1)));
    }
    ...
    public JMenu createMenu() {
        JMenu viewMenu = new JMenu(SettingsActions.bundle.getString("View"));
